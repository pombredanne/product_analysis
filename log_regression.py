...
if __name__ == "__main__":
    ...
    act_proj_ba  = u_info[(~u_info.first_date_of_getting_pv.isnull()) & (u_info.user_created_at < u_info.first_date_of_getting_pv) & (u_info.Date < u_info.first_date_of_getting_pv)]
