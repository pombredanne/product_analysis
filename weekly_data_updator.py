...
raw = pd.read_csv("./week_data2/all_0904_week.csv")
raw = raw[(raw["year_iso"] == 2017)]

result = raw.groupby("week_iso").apply(get_short_return_of_asset)
...
#         "y_ax_label" : "Percentage of Login User (%)",
#         "x_ax_label" : "Week",
#         "data" : user_metrics["active_per"]
#     },
#     {
#         "name" : "Casual User Percentage",
#         "y_ax_label" : "Percentage of Login User (%)",
#         "x_ax_label" : "Week",
#         "data" : user_metrics["casual_per"]
#     },
#     {
...
#
# date_formate = workbook.add_format({'num_format': 'yyyy/mm/dd'})
#
